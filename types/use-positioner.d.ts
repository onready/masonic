 ...
 */
export declare function usePositioner({ width, columnWidth, columnGutter, columnCount, }: UsePositionerOptions, deps?: React.DependencyList): Positioner;
 ...
 */
export declare const createPositioner: (columnCount: number, columnWidth: number, columnGutter?: number) => Positioner;
